...
```{r}
#| label: geo-load-those-spatial-data
#| warning: FALSE
#| message: FALSE
#| cache: FALSE
#| tidy: TRUE
...
```{r}
#| label: geo-plot-those-spatial-data
#| warning: FALSE
#| message: FALSE
#| cache: FALSE
#| tidy: TRUE
...
```{r}
#| label: geo-variables-that-cluster
#| warning: FALSE
#| message: FALSE
#| cache: FALSE
#| tidy: TRUE
...
```{r}
#| label:  geo-plot-those-clusters-with-a-graph
#| warning: FALSE
#| message: FALSE
#| cache: FALSE
#| tidy: TRUE
...
::: note
**Note** <br/> Your values may be slightly different because there is this element of randomness within the clustering.
:::

```{r}
#| label: geo-map-the-iuc
#| warning: FALSE
#| message: FALSE
#| cache: FALSE
#| tidy: TRUE
...
1.  Your function should look something like: `automate_k_means(dataframe,number_of_clusters,input_variables)`
